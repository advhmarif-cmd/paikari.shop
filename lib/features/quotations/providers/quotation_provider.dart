...
final quoteCheckoutSessionProvider = FutureProvider.family<QuoteCheckoutSession?, String>((ref, sessionId) {
  return ref.watch(quotationRepositoryProvider).getCheckoutSession(sessionId);
});
